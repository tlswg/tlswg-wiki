...
While the WG will be considerate of perspectives of different TLS user communities, there is the possibility that a proposal, even one that is in scope, is not adopted. There can be many reasons for this outcome, but the most likely reason is lack of interest. Lack of interest can be attributed to many things, but two that spring to mind are:
